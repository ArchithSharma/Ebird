...
coopers <- read_ebd("/Users/archith/Downloads/amekes_FLORIDA.txt")

totaldata = auk_zerofill(x = coopers, sampling_events = sampling, collapse = TRUE)
...
coopers <- semi_join(coopers, in_region, by = "checklist_id")
...
checklists <- totaldata |> 
  dplyr::select(checklist_id, observer_id, type,
         ...
         number_observers)
write.csv(checklists, "/Users/archith/Downloads/cooperfull.csv")
